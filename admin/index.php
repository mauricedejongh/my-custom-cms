            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  <script type="text/javascript">
                    ...
                    function drawChart() {
                      var data = google.visualization.arrayToDataTable([
                        ...
                        <?php
                          ...
                          $comment_approved_count = mysqli_num_rows($select_approved_comments);
                        ...
                        <?php
                          $element_text = ['All posts', 'Active Posts', 'Draft Posts', 'Users', 'Subscriber Users', 'Comments', 'Pending Comments', 'Categories'];
                          $element_count = [$post_count, $post_publish_count, $post_draft_count, $user_admin_count, $user_subscriber_count, $comment_approved_count, $comment_unapproved_count, $category_count];
                   ...
                   <div id="columnchart_material" style="width: 98%; height: 500px; padding-left: 15px;"></div>
                </div>
